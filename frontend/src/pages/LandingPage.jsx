  ...
  return (
    <div className="min-h-screen bg-gold-light-bg-primary dark:bg-gold-bg-primary text-gold-light-text-primary dark:text-gold-text-primary font-sans">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-md bg-gold-light-bg-primary/80 dark:bg-gold-bg-primary/80 border-b border-gold-light-border dark:border-gold-border px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button 
            ...
            disabled={loading}
            className="bg-gold-light-accent dark:bg-gold-accent hover:bg-gold-light-accent-hover dark:hover:bg-gold-accent-hover active:scale-95 disabled:opacity-60 transition-all duration-200 motion-reduce:transition-none text-white dark:text-gold-bg-primary px-5 py-2 rounded-full font-medium flex items-center gap-2"
          >
      ...
      <section className="relative px-6 pt-32 pb-24 max-w-5xl mx-auto text-center animate-fade-in overflow-hidden">
        ...
        <p className="text-xl text-gold-light-text-secondary dark:text-gold-text-secondary max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <button 
            onClick={handleLaunch}
            disabled={loading}
            className="w-full sm:w-auto bg-gold-light-accent dark:bg-gold-accent hover:bg-gold-light-accent-hover dark:hover:bg-gold-accent-hover active:scale-95 disabled:opacity-60 transition-all duration-200 motion-reduce:transition-none text-white dark:text-gold-bg-primary px-8 py-3.5 rounded-full font-medium text-lg"
          >
            {user ? 'Go to Dashboard →' : 'Analyse a Video →'}
          </button>
          <a 
            href="#features"
            className="w-full sm:w-auto bg-gold-light-bg-tertiary dark:bg-gold-bg-tertiary hover:bg-gold-light-border dark:hover:bg-gold-border-subtle border border-gold-light-border dark:border-gold-border active:scale-95 transition-all duration-200 motion-reduce:transition-none px-8 py-3.5 rounded-full font-medium text-lg"
          >
            See how it works
          </a>
        </div>
